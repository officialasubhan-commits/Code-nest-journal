...
export function ImageUploadCropper({
  ...
  const onCropComplete = useCallback((_croppedArea: { width: number; height: number; x: number; y: number }, croppedAreaPixels: { width: number; height: number; x: number; y: number }) => {
